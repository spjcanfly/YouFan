package com.example.spj.youfan.dao;

import android.content.ContentValues;
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;

import com.example.spj.youfan.bean.shopcar.ShopCartBean;
...
public class ShoppingCartDao {
    ...
    public boolean isExistGood(String productID) {
        ...
        db = DBHelper.getInstance().getReadableDatabase();
        cursor = db.query(DBHelper.TB_SHOPPING_CART, null, ShopCartBean.KEY_PRODUCT_ID + "=?", new String[]{productID}, null, null, null);
    ...
    public void saveShoppingInfo(String productID, String num) {
        ...
        values.put(ShopCartBean.KEY_PRODUCT_ID, productID);
        values.put(ShopCartBean.KEY_NUM, num);
    ...
    public void deleteShoppingInfo(String productID) {
        ...
        db = DBHelper.getInstance().getReadableDatabase();
        db.delete(DBHelper.TB_SHOPPING_CART, ShopCartBean.KEY_PRODUCT_ID + " =?", new String[]{productID});
        close();
    }
    ...
    public void deleteGoodList(List<String> goodList) {
        ...
        for (int i = 0; i < goodList.size(); i++) {
            db.delete(DBHelper.TB_SHOPPING_CART, ShopCartBean.KEY_PRODUCT_ID + " =?", new String[]{goodList.get(i)});
        }
        close();
    }
    ...
    public void updateGoodsNum(String productID, String num) {
        ...
        if (productID != null && !"".equals(productID) && num != null && !"".equals(num)) {
            values.put("num", num);
            db.update(DBHelper.TB_SHOPPING_CART, values, ShopCartBean.KEY_PRODUCT_ID + "=?", new String[]{productID});
        }
        close();
    }
    ...
    public String getNumByProductID(String productID) {
        ...
        db = DBHelper.getInstance().getReadableDatabase();
        cursor = db.query(DBHelper.TB_SHOPPING_CART, new String[]{ShopCartBean.KEY_NUM}, ShopCartBean.KEY_PRODUCT_ID + "=?", new String[]{productID}, null, null, null);
        if (cursor.moveToFirst()) {
    ...
    public List<String> getProductList() {
        ...
        Cursor cursor = db.query(DBHelper.TB_SHOPPING_CART, new String[]{ShopCartBean.KEY_PRODUCT_ID}, null, null, null, null, null);
        if (cursor.moveToFirst()) {
            do {
